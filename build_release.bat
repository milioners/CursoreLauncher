...
cd release
powershell -Command "Compress-Archive -Path 'CursorLauncher.exe', 'README.md', 'USER_GUIDE.md', 'CHANGELOG.md' -DestinationPath 'CursorLauncher-v1.2.0.zip' -Force"
cd ..

echo ========================================
echo Готово! Архив для релиза создан:
echo release\CursorLauncher-v1.2.0.zip
echo ========================================
echo.
echo Следующие шаги:
echo 1. Загрузите архив на GitHub в разделе Releases
echo 2. Создайте новый релиз с тегом v1.2.0
